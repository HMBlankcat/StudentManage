...
{
    public partial class AdminCouMan : Form
    {
        public AdminCouMan()
        {
            InitializeComponent();
        ...
        private void AdminCouMan_Load(object sender, EventArgs e)
        {
            Table();
        }
        public void Table()
        ...
        {
            AdminCouAdd admstumanADD = new AdminCouAdd();//新建窗口
            this.Hide();//隐藏当前窗口
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string a6 = dataGridView1.SelectedRows[0].Cells[5].Value.ToString();//获取编号
            string a7 = dataGridView1.SelectedRows[0].Cells[6].Value.ToString();

            AdminCouRe admstumanRE = new AdminCouRe(a1,a2,a3,a4,a6,a7);//新建窗口
            this.Hide();//隐藏当前窗口
